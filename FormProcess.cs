...
public class FormProcess : Form
{
  ...
  private void InitializeComponent()
  {
    ...
    this.progressBar.Location = new Point(12, 149);
    ...
    this.labelInfo.BackColor = SystemColors.Control;
    this.labelInfo.Location = new Point(12, (int) sbyte.MaxValue);
    this.labelInfo.Name = "labelInfo";
    this.labelInfo.Size = new Size(400, 19);
    ...
    this.pictureBoxImage.BorderStyle = BorderStyle.Fixed3D;
    this.pictureBoxImage.Location = new Point(12, 12);
    this.pictureBoxImage.Name = "pictureBoxImage";
    this.pictureBoxImage.Size = new Size(400, 100);
    ...
    this.ClientSize = new Size(424, 185);
