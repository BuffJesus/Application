...
{
  internal static int __\u0040\u0040_PchSym_\u004000\u0040UuzyovnlwUhixUuzyovnlwOxoixlivUcGEUivovzhvUhgwzucOlyq\u0040;
...
label_12:;
  ...
  [DllImport("", EntryPoint = "", CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
  [MethodImpl(MethodImplOptions.Unmanaged, MethodCodeType = MethodCodeType.Native)]
  internal static extern unsafe int SetFilePointerEx(
    [In] void* obj0,
    [In] _LARGE_INTEGER obj1,
    [In] _LARGE_INTEGER* obj2,
    [In] uint obj3);
