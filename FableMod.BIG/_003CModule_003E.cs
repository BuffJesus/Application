...
{
  internal static int __\u0040\u0040_PchSym_\u004000\u0040UuzyovnlwUhixUuzyovnlwOyrtUcGEUivovzhvUhgwzucOlyq\u0040;
  ...
  internal static unsafe AssetEntryHeader* FableMod\u002EBIG\u002EAssetEntryHeader\u002E\u007Bctor\u007D(
    [In] AssetEntryHeader* obj0)
  {
    // ISSUE: initblk instruction
    __memset((IntPtr) obj0, 0, 64 /*0x40*/);
    return obj0;
  }
  ...
  internal static unsafe AssetEntryHeader* FableMod\u002EBIG\u002EAssetEntryHeader\u002E\u007Bctor\u007D(
    [In] AssetEntryHeader* obj0,
    AssetEntryHeader* src)
  {
    *(int*) obj0 = *(int*) src;
    *(int*) ((IntPtr) obj0 + 4L) = *(int*) ((IntPtr) src + 4L);
    *(int*) ((IntPtr) obj0 + 8L) = *(int*) ((IntPtr) src + 8L);
    *(int*) ((IntPtr) obj0 + 12L) = *(int*) ((IntPtr) src + 12L);
    *(int*) ((IntPtr) obj0 + 16L /*0x10*/) = *(int*) ((IntPtr) src + 16L /*0x10*/);
    *(int*) ((IntPtr) obj0 + 20L) = *(int*) ((IntPtr) src + 20L);
    *(int*) ((IntPtr) obj0 + 24L) = *(int*) ((IntPtr) src + 24L);
    *(long*) ((IntPtr) obj0 + 28L) = (long) \u003CModule\u003E.strdup((sbyte*) *(long*) ((IntPtr) src + 28L));
    *(int*) ((IntPtr) obj0 + 36L) = *(int*) ((IntPtr) src + 36L);
    uint num1 = (uint) *(int*) ((IntPtr) src + 40L);
    *(int*) ((IntPtr) obj0 + 40L) = (int) num1;
    void* voidPtr1 = \u003CModule\u003E.@new((ulong) num1 * 12UL);
    *(long*) ((IntPtr) obj0 + 44L) = (long) voidPtr1;
    uint num2 = 0;
    if (0U < (uint) *(int*) ((IntPtr) obj0 + 40L))
    {
      void* voidPtr2 = voidPtr1;
      long num3 = 0;
      do
      {
        *(int*) (num3 + (IntPtr) voidPtr2) = *(int*) (num3 + *(long*) ((IntPtr) src + 44L));
        voidPtr2 = (void*) *(long*) ((IntPtr) obj0 + 44L);
        *(long*) ((IntPtr) voidPtr2 + num3 + 4L) = (long) \u003CModule\u003E.strdup((sbyte*) *(long*) (*(long*) ((IntPtr) src + 44L) + num3 + 4L));
        ++num2;
        num3 += 12L;
      }
      while (num2 < (uint) *(int*) ((IntPtr) obj0 + 40L));
    }
    uint num4 = (uint) *(int*) ((IntPtr) src + 52L);
    *(int*) ((IntPtr) obj0 + 52L) = (int) num4;
    void* voidPtr3 = \u003CModule\u003E.@new((ulong) num4);
    *(long*) ((IntPtr) obj0 + 56L) = (long) voidPtr3;
    // ISSUE: cpblk instruction
    __memcpy((IntPtr) voidPtr3, *(long*) ((IntPtr) src + 56L), (long) (uint) *(int*) ((IntPtr) obj0 + 52L));
    return obj0;
  }

  internal static unsafe void FableMod\u002EBIG\u002EAssetEntryHeader\u002E\u007Bdtor\u007D(
    [In] AssetEntryHeader* obj0)
  {
    ulong num1 = (ulong) *(long*) ((IntPtr) obj0 + 28L);
    if (num1 != 0UL)
      \u003CModule\u003E.delete((void*) num1);
    if (*(long*) ((IntPtr) obj0 + 44L) != 0L)
    {
      uint num2 = 0;
      if (0U < (uint) *(int*) ((IntPtr) obj0 + 40L))
      {
        ...
        do
        {
          ulong num4 = (ulong) *(long*) (*(long*) ((IntPtr) obj0 + 44L) + num3 + 4L);
          if (num4 != 0UL)
      ...
      \u003CModule\u003E.delete((void*) *(long*) ((IntPtr) obj0 + 44L));
    }
    ulong num5 = (ulong) *(long*) ((IntPtr) obj0 + 56L);
    if (num5 == 0UL)
      return;
...
label_12:;
  ...
  [DllImport("", EntryPoint = "", CallingConvention = CallingConvention.Cdecl, SetLastError = true)]
  [MethodImpl(MethodImplOptions.Unmanaged, MethodCodeType = MethodCodeType.Native)]
  internal static extern unsafe sbyte* strdup([In] sbyte* obj0);
