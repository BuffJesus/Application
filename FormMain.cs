...
public class FormMain : FormApp, FileInterface
{
  ...
  private void InitializeComponent()
  {
    ...
    this.panelLeft.Padding = new Padding(3);
    this.panelLeft.Size = new Size(174, 374);
    this.panelLeft.TabIndex = 2;
    this.listBoxFiles.ContextMenuStrip = this.contextMenuStripFile;
    this.listBoxFiles.Dock = DockStyle.Fill;
    this.listBoxFiles.FormattingEnabled = true;
    this.listBoxFiles.Location = new Point(3, 3);
    this.listBoxFiles.Name = "listBoxFiles";
    this.listBoxFiles.Size = new Size(168, 368);
    ...
    this.splitterMain.Location = new Point(174, 24);
    this.splitterMain.Name = "splitterMain";
    this.splitterMain.Size = new Size(6, 374);
    ...
    this.statusStrip.Location = new Point(0, 398);
    this.statusStrip.Name = "statusStrip";
    this.statusStrip.Size = new Size(560, 22);
    this.statusStrip.TabIndex = 5;
    this.statusStrip.Text = "Feel the Blaze...!!";
    this.toolStripStatusLabel.Name = "toolStripStatusLabel";
    this.toolStripStatusLabel.Size = new Size(94, 17);
